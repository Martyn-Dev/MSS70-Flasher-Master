    ...
    public partial class MainWindow : Window
    {
        ...
        private void LoadFile_1()
        {
            ...
            if (result == true)
            {
                ...
                if (fullread == true && Global.openedFlash.Length != 0x100000)
                {
                    this.Dispatcher.Invoke(() =>
                    {
                ...
                if (fullread == true && Global.openedFlash != null)
                {
        ...
        private async void ReadDMEPartial()
...
private async void ReadDMEFull()
        ...
        private async void FlashDME_Data()
        {
            ...
            Checksums_Signatures ChecksumsSignatures = new Checksums_Signatures();
            {
                ...
                using (EdiabasNet ediabas = StartEdiabas())
                {
                    ...
                    if (fullread == true || Global.openedFlash.Length > 0x40000)
        ...
        private bool RequestSecurityAccess(EdiabasNet ediabas)
        {
            ...
            {                                      //Could add an option to lower baudrate for scenarios where it doesn't work. 
                                                    MessageBox.Show(Global.diagProtocol);            //On the other hand, probably shouldn't encourage flashing with an unstable connection
        ...
        private void ReadDME_Click(object sender, RoutedEventArgs e)
            {
                MessageBoxResult result = MessageBox.Show("Would you like to perform a full read?", "Select a read type....If you are not sure, press 'Yes'", MessageBoxButton.YesNoCancel);
                switch(result)
                {
